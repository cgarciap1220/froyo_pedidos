                        ...
                        foreach ($query as $key) {
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo base_url(); ?>Categoria_controller/vista_modificar_categoria/<?php echo $key->id_categoria ?>">
                                        <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                                    </a>
                                </td>
                                <td class="text-center">
                                    <a href="javascript:eliminar('<?php echo base_url(); ?>Categoria_controller/eliminar_categoria/<?php echo $key->id_categoria ?>')">
